...
#     def confirm_held_checkouts(self, local_event_ids: list[str]) -> dict:
#         """"Confirm as checkout" from the held-review screen — accepts the
#         sighted time already stored on a held checkout row (hold_reason
#         'early' or 'late') as the real checkout. See
#         local_db.confirm_held_checkouts."""
#         return local_db.confirm_held_checkouts(local_event_ids)
...
#     def leave_held_checkouts_open(self, local_event_ids: list[str]) -> dict:
#         """"Leave open" from the held-review screen — late-sighting rows
#         only. See local_db.leave_held_checkouts_open."""
#         return local_db.leave_held_checkouts_open(local_event_ids)
...
#     def confirm_held_check_ins(self, local_event_ids: list[str]) -> dict:
#         """"Confirm as check-in" from the held-review screen — accepts the
#         sighted time already stored on a held late check-in row. See
#         local_db.confirm_held_check_ins."""
#         return local_db.confirm_held_check_ins(local_event_ids)
