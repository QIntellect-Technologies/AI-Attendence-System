...
//  * ─────────────────────────────────────────────────────────────────────────────
//  * Live biometric attendance monitoring — camera MJPEG grid + detection sidebar.
//  *
//  * Architecture:
//  *   liveStreamApi.ts        → ALL network calls (single backend migration point)
//  *   useLiveStream.ts        → ALL stateful logic: polling, scope, intervals, abort
//  *   LiveAttendanceMonitor.tsx → pure render: reads hook, renders JSX. Zero fetch.
//  *
//  * Design: card-based light theme matching LiveCCTVTracking for visual consistency
//  * across both live-monitoring pages.
//  *
//  * Scope:
//  *   activeBranchId !== null → branch admin view (cameras scoped to that branch)
//  *   activeBranchId === null → global view (all cameras)
//  *
//  * Stream URL:
//  *   Always comes from backend LiveCamera.streamUrl (Flask MJPEG proxy).
//  *   Frontend never constructs or sends RTSP URLs.
//  */
...
//                 }}
//               >
//                 {det.userId != null && !imgErr ? (
//                   <img
//                     src={profilePhotoUrl(det.userId)}
//                     alt={det.name}
